export default {
  ...
  captureRoleDescription: "Los usuarios con este rol pueden realizar los cambios en los establecimientos de salud",
  approvalRole: "FCA - Aprobación",
  approvalRoleDescription: "Los usuarios con este rol no pueden ingresar datos, pero pueden aprobar los cambios",
  synchronizationRole: "FCA - Sincronización",
  synchronizationRoleDescription:
    "Los usuarios con este rol no pueden ingresar ni aprobar datos, pero pueden sincronizar los datos a la plataforma DHIS2",
  adminRole: "FCA - Administrador",
  adminRoleDescription: "Los usuarios con este rol pueden realizar la configuración del Módulo FCA y los metadatos",
