export default {
  ...
  captureRoleDescription: "Người dùng với vai trò này có thể thay đổi cơ sở",
  approvalRole: "FCA - Phê duyệt",
  approvalRoleDescription: "Người dùng với vai trò này không thể nhập liệu nhưng có thể phê duyệt các thay đổi",
  synchronizationRole: "FCA - Đồng bộ",
  synchronizationRoleDescription: "Người dùng với vài trò này không thể nhập liệu hoặc phê duyệt nhưng có thể đồng bộ dữ liệu vào cây đơn vị DHIS2",
  adminRole: "FCA - Quản trị viên",
  adminRoleDescription: "Người dùng với vai trò này có thể cấu hình cho Mô-đun FCA và siêu dữ liệu",
