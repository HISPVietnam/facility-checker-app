export default {
  ...
  captureRoleDescription: "Users with this role can do the changes for the facilities",
  approvalRole: "FCA - Approval",
  approvalRoleDescription: "Users with this role cannot do data entry but can approve the changes",
  synchronizationRole: "FCA - Synchronization",
  synchronizationRoleDescription: "Users with this role cannot do data entry or approval but can synchronize the data to DHIS2 hierarchy",
  adminRole: "FCA - Admin",
  adminRoleDescription: "Users with this role can make the configuration to FCA Module and metadata",
