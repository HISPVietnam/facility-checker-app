...
const Accordion = ({ title, children, defaultOpen = false }) => {
  ...
  return (
    <div className=" rounded-xl border border-gray-300 bg-white">
      {/* Header */}
      <button
        className={` rounded-xl flex w-full  sticky top-0 z-[10000] bg-white items-center justify-between p-2  text-left mb-1 ${
          open && "border-b border-gray-300 rounded-b-none"
        }`}
        onClick={() => setOpen((o) => !o)}
        aria-expanded={open}
      >
