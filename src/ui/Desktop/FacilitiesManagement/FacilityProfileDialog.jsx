...
const Row = ({ children, className }) => {
  return (
    <div className={`flex  py-1 border-b border-b-slate-200 ${className ? className : ""}`}>
      <div className="self-center w-[20%] text-[15px]">{children[0]}</div>
      <div className="self-start w-[40%]">
        {children[1]}
        {children[2]}
      </div>
      <div className="self-start flex flex-col w-[40%] ml-2 justify-between">
      ...
      <ModalContent>
        <div className="h-[65vh] w-[85vw]">
          ...
          <div className="flex items-center py-1 border-b-2 border-b-slate-400 font-bold text-[15px] h-[35px]">
            ...
            <div className="w-[40%]">{isPending ? t("awaitingApprovalValue") : t("newValue")}</div>
            <div className="w-[40%] ml-2">{isPending ? t("previousValue") : t("currentValue")}</div>
          </div>
            ...
            <Row className="mt-auto">
              ...
              <div className="w-full">
                <div className="flex w-full">
                  ...
                  <div className="w-[170px] h-full mt-auto ml-1">
                    <CustomizedButton
              ...
              <div>
                <div className="w-full h-[300px] mt-2">
                  <MiniMap
                    data={generateParentFeatures(currentFacility[PATH] || selectedFacility.previousValues[PATH])}
                    point={currentFacility.longitude && selectedFacility.latitude ? [currentFacility.latitude, currentFacility.longitude] : null}
                  />
                </div>
              ...
              <div className="w-full h-[300px] mt-2">
                <MiniMap
                  data={generateParentFeatures(selectedFacility.previousValues[PATH])}
                  point={
                    selectedFacility.previousValues.longitude && selectedFacility.previousValues.latitude
                      ? [selectedFacility.previousValues.latitude, selectedFacility.previousValues.longitude]
                      : null
