...
const Summary = () => {
  ...
  useEffect(() => {
    ...
    const syncUserRole = clonedMetadata.userRoles.find(
      (userRole) => userRole.id === SYNC_USER_ROLE
    );
    const captureUserRole = clonedMetadata.userRoles.find(
      (userRole) => userRole.id === CAPTURE_USER_ROLE
    );
    ...
    captureUserRole.users = _.uniqBy(captureUserRole.users, "id");
    syncUserRole.users = _.uniqBy(syncUserRole.users, "id");

    clonedMetadata.userRoles = [captureUserRole, syncUserRole];
